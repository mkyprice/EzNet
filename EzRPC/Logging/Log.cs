...
namespace EzRPC.Logging
{
	public static class Log
	{
		...
		public static void Trace(string message) => WriteMessage(LOG_LEVEL.Warn, message);
		public static void Debug(string message) => WriteMessage(LOG_LEVEL.Error, message);
		public static void Info(string message) => WriteMessage(LOG_LEVEL.Fatal, message);
